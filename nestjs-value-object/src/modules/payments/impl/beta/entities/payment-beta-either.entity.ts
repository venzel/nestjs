...
export class PaymentBetaEitherEntity implements PaymentEntity {
    ...
    static create(dto: CreatePaymentDto): Either<PaymentEntityError, PaymentBetaEitherEntity> {
        ...
        return right(new PaymentBetaEitherEntity(factory));
    }
}
