...
import { CreatePaymentBetaDto } from '../dtos';
...
export class PaymentBetaValueEntity implements PaymentEntity {
    ...
    static create(dto: CreatePaymentBetaDto): PaymentBetaValueEntity {
        ...
        return new PaymentBetaValueEntity(factory);
    }
}
